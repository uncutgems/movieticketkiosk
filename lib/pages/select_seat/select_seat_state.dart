...
class ReceiveSeatDataSelectSeatState extends SelectSeatState {
  ReceiveSeatDataSelectSeatState(
      this.seatList, this.totalPrice, this.chosenList);
...
class MoveToNextScreenSelectSeatState extends SelectSeatState {
  MoveToNextScreenSelectSeatState(this.chosenList, this.session);
